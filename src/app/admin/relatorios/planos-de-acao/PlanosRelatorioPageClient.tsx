...
/**
 * Client component for the action plan report page.
 * Auth is handled server-side by the parent page.tsx.
 */
export default function PlanosRelatorioPageClient() {
  ...
  }, [supabase, periodPreset, customFrom, customTo, storeFilter, templateFilter, severityFilter, statusFilter, assigneeFilter, stores.length])
  ...
  const handleExportPdf = async () => {
    if (!canExportPdf || exportingPdf || items.length === 0) return
    setExportMenuOpen(false)
