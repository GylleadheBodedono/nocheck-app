...
interface LogsPageClientProps {
  initialLogs: ClientLog[]
}

/**
 * Client component for the logs page (`/admin/logs`).
 * Renders logs with filtering, expanding, delete, clear and refresh functionality.
 */
export default function LogsPageClient({ initialLogs }: LogsPageClientProps) {
  const [logs, setLogs] = useState<ClientLog[]>(initialLogs)
  ...
  return (
    ...
    <PageContainer>
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4">
        ...
        <button onClick={refetchLogs} disabled={refreshing} className="btn-ghost p-2" title="Atualizar">
