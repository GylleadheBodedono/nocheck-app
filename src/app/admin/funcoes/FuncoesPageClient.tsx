...
interface FuncoesPageClientProps {
  initialFunctions: FunctionWithStats[]
}

/**
 * Client component for the functions management page (`/admin/funcoes`).
 * CRUD for roles (e.g. Estoquista, Supervisor, Aprendiz) that control
 * which templates each role can fill.
 */
export default function FuncoesPageClient({ initialFunctions }: FuncoesPageClientProps) {
  const [functions, setFunctions] = useState<FunctionWithStats[]>(initialFunctions)
