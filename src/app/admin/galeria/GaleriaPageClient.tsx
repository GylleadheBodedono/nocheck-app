...
/**
 * Client component for the gallery page (`/admin/galeria`).
 * Displays all photos taken during checklist filling,
 * paginated (24 per page) and organized by folder (`uploads` / `anexos`).
 *
 * Auth is handled by the server component wrapper.
 */
