// ============================================
// BillingPageClient — Client component for billing
// ============================================
...
export default function BillingPageClient({ initialOrg, initialUsage }: BillingPageClientProps) {
  const [org] = useState<OrgBilling | null>(initialOrg)
  const [usage] = useState<UsageStats>(initialUsage)
